async function get_token(client_secret) {
...
const token = await get_token(process.env.CLIENT_SECRET);
const promises = [];
for (let i = 0; i < 5; i++) {
...
console.log(`const menu_per_day = ${JSON.stringify(menu_per_day, null, 2)};`)
